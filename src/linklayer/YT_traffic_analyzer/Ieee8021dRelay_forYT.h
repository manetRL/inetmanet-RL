...
#ifndef IEEE8021DRelay_FORYT_H_
#define IEEE8021DRelay_FORYT_H_
...
//
class INET_API Ieee8021dRelay_forYT : public cSimpleModule, public ILifecycle
{
    public:
        Ieee8021dRelay_forYT();
